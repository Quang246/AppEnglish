...
import com.example.appenglish.MatchWordActivity;
import com.example.appenglish.PracticeActivity;
...
public class PracticeWordAdapter extends RecyclerView.Adapter<PracticeWordAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public PracticeWordAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_practice_word, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull PracticeWordAdapter.ViewHolder holder, int position) {
